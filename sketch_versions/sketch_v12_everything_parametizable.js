...
function setup() {
  ...
  let position = createVector(500, 500);
  let numPetals = 64;
  let stemLength = 250;
  let petalColor = color(222, 5, 82);
  let petalLength = 40;
  let petalWidth = 10;
  let noisePetalFormScale = 3;
  let noisePetalPositionScale = 10;
  let noisePetalInteriorOffsetScale = 0.2;
  let noisePetalExteriorOffsetScale = 0.1;
  let noiseStemCurvePositionScale = 15;
  let noiseStemCurveOffsetScale = 0.2;
  let noiseStemStrokeScale = 2;
